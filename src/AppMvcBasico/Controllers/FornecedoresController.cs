...
namespace AppMvcBasico.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public FornecedoresController(AppMvcBasicoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Fornecedores != null ?
                        ...
                        Problem("Entity set 'AppMvcBasicoContext.Fornecedores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'AppMvcBasicoContext.Fornecedores'  is null.");
            }
            var fornecedor = await _context.Fornecedores.FindAsync(id);
            if (fornecedor != null)
            {
